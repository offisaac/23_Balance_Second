...
/* Private define ------------------------------------------------------------*/
extern bool leapState;
extern float angle_error;
extern float fact_target_speed;
/* Private variables ---------------------------------------------------------*/
/**
 * @brief
 */
...
void UpperMonitor_Sent_Choose(float *data)
{
  ...
  for (i = 0; i < Sent_Data_Num; i++)
  {
    ...
    case 3:
      ...
      break;
    case 4:
      data[i] = balance_infantry.balance_controller.current_location.y;
      break;
    case 5:
    ...
    case 6:
      ...
      //      break;
      //			case 1: data[i] = balance_infantry.balance_controller.idling_count;//前馈环输出
      //			break;
      //			case 2: data[i] = balance_infantry.balance_controller.current_linearSpeed.y/balance_infantry.balance_controller.motor_current;//距离环输出
      //			break;
      //			case 3: data[i] = balance_infantry.balance_controller.idling_flag;//速度环输出
      //			break;
      //			case 4: data[i] = (float)balance_infantry.balance_controller.real_count;//转向环输出
      //			break;
      //			case 5: data[i] = balance_infantry.balance_controller.weightless_flag;//自适应输出
      //			break;
      //			case 6: data[i] = balance_infantry.balance_controller.current_linearAcc.x;
      //			break;
      //			case 7: data[i] = balance_infantry.balance_controller.current_linearAcc.y;
      //			break;
      //			case 8: data[i] = balance_infantry.balance_controller.current_linearAcc.z;
      //			break;
      /*输出观测*/
      //			case 0: data[i] = debug_out_A;//直立环输出
      //      break;
      //			case 1: data[i] = debug_out_B;//前馈环输出
      //			break;
      //			case 2: data[i] = debug_out_C;//距离环输出
      //			break;
      //			case 3: data[i] = debug_out_D;//速度环输出
      //			break;
      //			case 4: data[i] = debug_out_E;//转向环输出
      //			break;
      //			case 5: data[i] = debug_out_F;//自适应输出
      //			break;
      //			case 6: data[i] = balance_infantry.balance_controller.current_pos.pitch;
      //			break;
      //			case 7: data[i] = balance_infantry.Source_Cap_Voltage;
      //			break;
      //			case 8: data[i] = balance_infantry.Board_Com.gimbal_rx_pack2.cap_voltage;
      //			break;

      //				case 0: data[i] = balance_infantry.Source_Cap_Voltage;
      //				break;
      //				case 1: data[i] = balance_infantry.Source_Manage.power.pow_motor;
      //				break;
      //				case 2: data[i] = balance_infantry.Source_Manage.power.pow_Charge;
      //				break;
      //				case 3: data[i] = balance_infantry.Source_Manage.power.pow_In;
      //				break;
      //				case 4: data[i] = balance_infantry.chassis_power_limit;
      //				break;
      //				case 5: data[i] = balance_infantry.Source_Manage.DPW.out_duty;
      //				break;
      //				case 6: data[i] = balance_infantry.Power_Ctrl.Get_capChargePower();
      //				break;
      //				case 7: data[i] = balance_infantry.Source_Manage.DPW.I_chg_H;
      //				break;
      //				case 8: data[i] = balance_infantry.Source_Manage.voltage_Loop.Out;
      //				break;
      //				default:
      //				break;

      //      case 0: data[i] = balance_infantry.Source_Manage.power.pow_In;//直立环输出
      //      break;
      //			case 1: data[i] = balance_infantry.wheel_motor[RIGHT].Out;//前馈环输出
      //			break;
      //			case 2: data[i] = balance_infantry.wheel_motor[LEFT].Out;//距离环输出
      //			break;
      //			case 3: data[i] = balance_infantry.Source_Cap_Voltage;//速度环输出
      //			break;
      //			case 4: data[i] = balance_infantry.balance_controller.current_angularSpeed.yaw;//转向环输出
      //			break;
      //			case 5: data[i] = balance_infantry.balance_controller.current_linearSpeed.y;//自适应输出
      //			break;
      //			case 6: data[i] = balance_infantry.balance_controller.target_linearSpeed.y;
      //			break;
      //			case 7: data[i] = debug_out_F;
      //			break;
      //			case 8: data[i] = (float)leapState;
      //			break;

      //      default:break;

      //			case 0: data[i] = balance_infantry.balance_controller.is_rotation_crash;
      //				break;
      //			case 1: data[i] = fact_target_speed;
      //				break;
      //			case 2: data[i] = balance_infantry.balance_controller.target_rotation_r;
      //				break;
      //			case 3: data[i] = cosf(balance_infantry.balance_controller.angle_error);
      //				break;
      //			case 4: data[i] = balance_infantry.balance_controller.target_linearSpeed.y;
      //				break;
      //			case 5: data[i] = balance_infantry.balance_controller.target_rotation_angle;
      //				break;
      //			case 6: data[i] = cosf(balance_infantry.balance_controller.angle_error)*balance_infantry.balance_controller.target_rotation_r;
      //				break;
      //			case 7: data[i] = balance_infantry.balance_controller.rotation_chassis_angle;
      //				break;
