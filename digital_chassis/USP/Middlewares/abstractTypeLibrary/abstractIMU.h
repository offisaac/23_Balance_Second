...
namespace abstractIMU
{
    ...
    private:
        ...
        virtual float getPitchVel() = 0;
        virtual float getYawVel() = 0;
        virtual float getRollVel() = 0;
    ...
    public:
        ...
        void bindEulerCoordinate(imuEulerCoordinate abstractPitch, imuEulerCoordinate abstractYaw, imuEulerCoordinate abstractRoll)
        {
        ...
        void bindAccCoordinate(imuAccCoordinate abstractX, imuAccCoordinate abstractY, imuAccCoordinate abstractZ)
        {
...
private:
    ...
    inline virtual float getACCX()
    {
        if (lpms == nullptr)
            return 0;
        return lpms->get_data().calAccX;
    }
    inline virtual float getACCY()
    {
        if (lpms == nullptr)
            return 0;
        return lpms->get_data().calAccY;
    }
    inline virtual float getACCZ()
    {
        if (lpms == nullptr)
            return 0;
        return lpms->get_data().calAccZ;
    }
