...
void tskRefereeUI(void *arg)
{
  ...
  for (;;)
  {
    ...
    else
    {
      ...
      balance_infantry.Referee.Draw_Balance_State(0,balance_infantry.balance_controller.current_pos.pitch, - balance_infantry.gimbal_data.chassis_rotation_angle / 180.0f * PI + PI / 2.f, 700, 120, 100, GREEN);
      //      else
